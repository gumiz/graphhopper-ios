...
@implementation GnuTroveImplHashTLongIntHash
...
- (jint)setUpWithInt:(jint)initialCapacity {
  ...
  GnuTroveImplHashTLongIntHash_setAndConsume__set_(self, [IOSLongArray newArrayWithLength:capacity]);
  return capacity;
}
...
- (void)copyAllFieldsTo:(GnuTroveImplHashTLongIntHash *)other {
  [super copyAllFieldsTo:other];
  GnuTroveImplHashTLongIntHash_set__set_(other, _set_);
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "init", "TLongIntHash", NULL, 0x1, NULL },
    { "initWithInt:", "TLongIntHash", NULL, 0x1, NULL },
    { "initWithInt:withFloat:", "TLongIntHash", NULL, 0x1, NULL },
    { "initWithInt:withFloat:withLong:withInt:", "TLongIntHash", NULL, 0x1, NULL },
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "serialVersionUID_", NULL, 0x18, "J", NULL, .constantValue.asLong = GnuTroveImplHashTLongIntHash_serialVersionUID },
    { "_set_", NULL, 0x81, "[J", NULL,  },
    { "no_entry_key_", NULL, 0x4, "J", NULL,  },
    { "no_entry_value_", NULL, 0x4, "I", NULL,  },
    { "consumeFreeSlot_", NULL, 0x4, "Z", NULL,  },
  };
  static const J2ObjcClassInfo _GnuTroveImplHashTLongIntHash = { 1, "TLongIntHash", "gnu.trove.impl.hash", NULL, 0x401, 18, methods, 5, fields, 0, NULL};
  return &_GnuTroveImplHashTLongIntHash;
}

@end

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(GnuTroveImplHashTLongIntHash)
