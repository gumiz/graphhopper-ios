...
//  source: dependencies/trove/src/gnu/trove/impl/hash/TIntLongHash.java
//

#ifndef _GnuTroveImplHashTIntLongHash_H_
#define _GnuTroveImplHashTIntLongHash_H_
...
#define GnuTroveImplHashTIntLongHash_serialVersionUID 1LL

/**
 @brief An open addressed hashing implementation for int/long primitive entries.
 ...
 */
@interface GnuTroveImplHashTIntLongHash : GnuTroveImplHashTPrimitiveHash {
 @public
  /**
...
/**
 @brief Creates a new <code>TIntLongHash</code> instance with a prime value at or near the specified capacity and load factor.
...
J2OBJC_EMPTY_STATIC_INIT(GnuTroveImplHashTIntLongHash)

J2OBJC_FIELD_SETTER(GnuTroveImplHashTIntLongHash, _set_, IOSIntArray *)

CF_EXTERN_C_BEGIN

J2OBJC_STATIC_FIELD_GETTER(GnuTroveImplHashTIntLongHash, serialVersionUID, jlong)
CF_EXTERN_C_END

J2OBJC_TYPE_LITERAL_HEADER(GnuTroveImplHashTIntLongHash)

#endif // _GnuTroveImplHashTIntLongHash_H_
