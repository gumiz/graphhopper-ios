...
@implementation GnuTroveImplHashTIntLongHash
...
- (jint)setUpWithInt:(jint)initialCapacity {
  ...
  GnuTroveImplHashTIntLongHash_setAndConsume__set_(self, [IOSIntArray newArrayWithLength:capacity]);
  return capacity;
}
...
- (void)copyAllFieldsTo:(GnuTroveImplHashTIntLongHash *)other {
  [super copyAllFieldsTo:other];
  GnuTroveImplHashTIntLongHash_set__set_(other, _set_);
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "init", "TIntLongHash", NULL, 0x1, NULL },
    { "initWithInt:", "TIntLongHash", NULL, 0x1, NULL },
    { "initWithInt:withFloat:", "TIntLongHash", NULL, 0x1, NULL },
    { "initWithInt:withFloat:withInt:withLong:", "TIntLongHash", NULL, 0x1, NULL },
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "serialVersionUID_", NULL, 0x18, "J", NULL, .constantValue.asLong = GnuTroveImplHashTIntLongHash_serialVersionUID },
    { "_set_", NULL, 0x81, "[I", NULL,  },
    { "no_entry_key_", NULL, 0x4, "I", NULL,  },
    { "no_entry_value_", NULL, 0x4, "J", NULL,  },
    { "consumeFreeSlot_", NULL, 0x4, "Z", NULL,  },
  };
  static const J2ObjcClassInfo _GnuTroveImplHashTIntLongHash = { 1, "TIntLongHash", "gnu.trove.impl.hash", NULL, 0x401, 18, methods, 5, fields, 0, NULL};
  return &_GnuTroveImplHashTIntLongHash;
}

@end

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(GnuTroveImplHashTIntLongHash)
