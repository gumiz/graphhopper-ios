...
//  source: dependencies/trove/src/gnu/trove/impl/hash/TLongIntHash.java
//

#ifndef _GnuTroveImplHashTLongIntHash_H_
#define _GnuTroveImplHashTLongIntHash_H_
...
#define GnuTroveImplHashTLongIntHash_serialVersionUID 1LL

/**
 @brief An open addressed hashing implementation for long/int primitive entries.
 ...
 */
@interface GnuTroveImplHashTLongIntHash : GnuTroveImplHashTPrimitiveHash {
 @public
  /**
...
/**
 @brief Creates a new <code>TLongIntHash</code> instance with a prime value at or near the specified capacity and load factor.
...
J2OBJC_EMPTY_STATIC_INIT(GnuTroveImplHashTLongIntHash)

J2OBJC_FIELD_SETTER(GnuTroveImplHashTLongIntHash, _set_, IOSLongArray *)

CF_EXTERN_C_BEGIN

J2OBJC_STATIC_FIELD_GETTER(GnuTroveImplHashTLongIntHash, serialVersionUID, jlong)
CF_EXTERN_C_END

J2OBJC_TYPE_LITERAL_HEADER(GnuTroveImplHashTLongIntHash)

#endif // _GnuTroveImplHashTLongIntHash_H_
