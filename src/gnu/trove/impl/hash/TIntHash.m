...
@implementation GnuTroveImplHashTIntHash

- (instancetype)init {
  if (self = [super init]) {
    no_entry_value_ = GnuTroveImplConstants_get_DEFAULT_INT_NO_ENTRY_VALUE_();
...
- (jint)setUpWithInt:(jint)initialCapacity {
  ...
  GnuTroveImplHashTIntHash_setAndConsume__set_(self, [IOSIntArray newArrayWithLength:capacity]);
  return capacity;
}
...
- (void)removeAtWithInt:(jint)index {
  *IOSIntArray_GetRef(nil_chk(_set_), index) = no_entry_value_;
...
- (jint)indexWithInt:(jint)val {
  ...
  if (state == GnuTroveImplHashTPrimitiveHash_FULL && IOSIntArray_Get(nil_chk(set), index) == val) return index;
  return [self indexRehashedWithInt:val withInt:index withInt:hash_ withByte:state];
}
...
- (void)copyAllFieldsTo:(GnuTroveImplHashTIntHash *)other {
  [super copyAllFieldsTo:other];
  GnuTroveImplHashTIntHash_set__set_(other, _set_);
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "init", "TIntHash", NULL, 0x1, NULL },
    { "initWithInt:", "TIntHash", NULL, 0x1, NULL },
    { "initWithInt:withFloat:", "TIntHash", NULL, 0x1, NULL },
    { "initWithInt:withFloat:withInt:", "TIntHash", NULL, 0x1, NULL },
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "serialVersionUID_", NULL, 0x18, "J", NULL, .constantValue.asLong = GnuTroveImplHashTIntHash_serialVersionUID },
    { "_set_", NULL, 0x81, "[I", NULL,  },
    { "no_entry_value_", NULL, 0x4, "I", NULL,  },
    { "consumeFreeSlot_", NULL, 0x4, "Z", NULL,  },
  };
  static const J2ObjcClassInfo _GnuTroveImplHashTIntHash = { 1, "TIntHash", "gnu.trove.impl.hash", NULL, 0x401, 14, methods, 4, fields, 0, NULL};
  return &_GnuTroveImplHashTIntHash;
}

@end

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(GnuTroveImplHashTIntHash)
