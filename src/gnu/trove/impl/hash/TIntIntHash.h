...
#ifndef _GnuTroveImplHashTIntIntHash_H_
#define _GnuTroveImplHashTIntIntHash_H_
...
#define GnuTroveImplHashTIntIntHash_serialVersionUID 1LL

/**
 @brief An open addressed hashing implementation for int/int primitive entries.
 ...
 */
@interface GnuTroveImplHashTIntIntHash : GnuTroveImplHashTPrimitiveHash {
 @public
  /**
...
/**
 @brief Creates a new <code>TIntIntHash</code> instance with a prime value at or near the specified capacity and load factor.
...
J2OBJC_EMPTY_STATIC_INIT(GnuTroveImplHashTIntIntHash)

J2OBJC_FIELD_SETTER(GnuTroveImplHashTIntIntHash, _set_, IOSIntArray *)

CF_EXTERN_C_BEGIN

J2OBJC_STATIC_FIELD_GETTER(GnuTroveImplHashTIntIntHash, serialVersionUID, jlong)
CF_EXTERN_C_END

J2OBJC_TYPE_LITERAL_HEADER(GnuTroveImplHashTIntIntHash)

#endif // _GnuTroveImplHashTIntIntHash_H_
