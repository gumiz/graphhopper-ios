...
#ifndef _GnuTroveMapTLongObjectMap_H_
#define _GnuTroveMapTLongObjectMap_H_

@class IOSLongArray;
@class IOSObjectArray;
@protocol GnuTroveFunctionTObjectFunction;
@protocol GnuTroveIteratorTLongObjectIterator;
@protocol GnuTroveProcedureTLongObjectProcedure;
...
/**
 @brief Interface for a primitive map of long keys and Object values.
 */
@protocol GnuTroveMapTLongObjectMap < NSObject, JavaObject >
...
/**
 ...
 @return the <tt>long</tt> value to which the specified key is mapped, or <code>null</code> if this map contains no mapping for the key
 @throws ClassCastException if the key is of an inappropriate type for this map (optional)
 @throws NullPointerException if the specified key is null and this map does not permit null keys (optional)
 */
...
/**
 ...
 If the map previously contained a mapping for the key, the old value is replaced by the specified value.  (A map <tt>m</tt> is said to contain a mapping for a key <tt>k</tt> if and only if #containsKey(long) m.containsKey(k) would return <tt>true</tt>.)
...
/**
 ...
 @return the previous <tt>long</tt> value associated with <tt>key</tt>, or <tt>null</tt> if there was no mapping for <tt>key</tt>.
...
/**
 ...
 The effect of this call is equivalent to that of calling #put(long,Object) put(k, v) on this map once for each mapping from key <tt>k</tt> to value <tt>v</tt> in the specified map.  The behavior of this operation is undefined if the specified map is modified while the operation is in progress.
...
/**
 @brief Returns a TLongSet view of the keys contained in this map.
...
/**
 @brief Returns a <tt>TLongObjectIterator</tt> with access to this map's keys and values.
...
J2OBJC_EMPTY_STATIC_INIT(GnuTroveMapTLongObjectMap)

J2OBJC_TYPE_LITERAL_HEADER(GnuTroveMapTLongObjectMap)

#endif // _GnuTroveMapTLongObjectMap_H_
